...
// This script initializes the database with the required tables for XAMPP MySQL
async function main() {
  console.log('Starting database migration for XAMPP MySQL...');
  ...
  try {
    ...
    await connection.execute(`
      ...
      SELECT 'admin@example.com', '$2a$10$DW3AIAEPa7UjkFN4RpCQCuqh5FLSn.DLRoWEcqJtE1qFBsJ8WlqHi', 'Admin User', 'admin'
