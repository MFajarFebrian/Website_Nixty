  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<div class="text-center py-12 bg-white rounded-lg shadow-md"><div class="text-5xl mb-4">🛒</div><h2 class="text-2xl font-bold text-gray-700 mb-4">Your cart is empty</h2><p class="text-gray-600 mb-6">Looks like you haven&#39;t added any products to your cart yet.</p>`);
        ...
        ssrRenderList(unref(cart), (item) => {
          ...
          if (item.image_url) {
            ...
            _push(`<div class="text-3xl text-gray-300"><span>📄</span></div>`);
          }
...
//# sourceMappingURL=cart-DpiX7ka-.js.map
